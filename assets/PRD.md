...
- Turn notifications: a turn tone — left, right or U-turn (Audio.md, "Turn Tones"), held back during an L3 alert or a sounding Warning — plus a centred turn instruction (UX.md §S05, "Turn instructions") at configurable distance from turn
