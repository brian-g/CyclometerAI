...
struct SettingsData {
    static let privacyPolicyParagraphs = [
        ...
        "Cyclometer doesn't require an account or login. Your ride and location data stay on your device unless you explicitly export a GPX file or link a connected service, with one exception: to name a ride after the town it started in, Cyclometer sends the ride's starting point to Apple's map service. Turn off Place Names in Settings to stop this. We never sell your data or share it with third parties for advertising. You can change location, Bluetooth, motion, or Health permissions anytime in iOS Settings; deleting the app removes all locally stored ride data."
    ]
}
