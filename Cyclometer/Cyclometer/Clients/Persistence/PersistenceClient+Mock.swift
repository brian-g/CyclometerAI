...
extension PersistenceClient {
    static func mock(
        ...
        onRenameRide: @escaping @Sendable (UUID, String) -> Void = { _, _ in },
        onReplaceRideGPX: @escaping @Sendable (UUID, Data) -> Void = { _, _ in },
        ...
        PersistenceClient(
            ...
            renameRide: { onRenameRide($0, $1) },
            replaceRideGPX: { onReplaceRideGPX($0, $1) },
